...
// and IRS Topic 751 for Medicare thresholds
// YEAR: 2026
 ...
 * SOURCE: IRS IR-2025-103 / Revenue Procedure 2025-32.
 * Same as single filer brackets for 2026.
 */
export const federalBrackets2026MarriedSeparately: TaxBracket[] = [
  { min: 0, max: 12_400, rate: 0.1 },
  { min: 12_400, max: 50_400, rate: 0.12 },
  { min: 50_400, max: 105_700, rate: 0.22 },
  { min: 105_700, max: 201_775, rate: 0.24 },
 ...
 * SOURCE: Tax Foundation analysis of Revenue Procedure 2025-32.
 */
export const federalBrackets2026HeadOfHousehold: TaxBracket[] = [
